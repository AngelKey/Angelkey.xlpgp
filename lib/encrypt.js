...
(function() {
  ...
  exports.Encryptor = Encryptor = (function() {
    ...
    Encryptor.prototype._write_header = function(_arg, cb) {
      var dummy, esc, first_hmac, packet, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      first_hmac = _arg.first_hmac, dummy = _arg.dummy;
        ...
        return (function(__iced_k) {
          ...
          _while = function(__iced_k) {
            ...
            if (!go) {
              ...
              packetno = i + 1;
              (function(__iced_k) {
                if ((i % _this["const"].hashes_per_index_packet) === 0) {
                  (function(__iced_k) {
                    __iced_deferrals = new iced.Deferrals(__iced_k, {
                      parent: ___iced_passed_deferral,
                      filename: "/Users/max/src/keybase/xlpgp/src/encrypt.iced",
