...
(function() {
  var BlockReader, PacketWriter, iced, make_esc, __iced_k, __iced_k_noop;
  ...
  exports.BlockReader = BlockReader = (function() {
    function BlockReader(_arg) {
      this.stubs = _arg.stubs, this.config = _arg.config;
      this._pos = 0;
    }

    BlockReader.prototype.read = function(cb) {
      var buf, eof, err, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      (function(_this) {
        return (function(__iced_k) {
          __iced_deferrals = new iced.Deferrals(__iced_k, {
            parent: ___iced_passed_deferral,
            filename: "/Users/max/src/keybase/xlpgp/src/io.iced",
            funcname: "BlockReader.read"
          });
          _this.stubs.read({
            start: _this._pos,
            bytes: _this.config.blocksize
        ...
        return function() {
          if (typeof err === "undefined" || err === null) {
            _this._pos += buf.length;
          }
          eof = !err && (!(typeof buf !== "undefined" && buf !== null) || (buf.length === 0));
          return cb(err, buf, eof);
        };
      })(this));
    };
