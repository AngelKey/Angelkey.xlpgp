...
(function() {
  ...
  exports.PacketWriter = PacketWriter = (function() {
    ...
    PacketWriter.prototype.rewind = function() {
      this._pos = 0;
      return this._index = 0;
    };

    PacketWriter.prototype.write = function(_arg, cb) {
      var buf, esc, p, packet, packets, start, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      packet = _arg.packet, packets = _arg.packets;
